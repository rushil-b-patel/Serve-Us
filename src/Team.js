  ...
  export default function Team() {
    return (
      <div className=" bg-white py-10">
        <div className="sm:justify-center mx-auto grid max-w-7xl gap-x-8 gap-y-10 px-6 lg:px-8 xl:grid-cols-3">
              ...
              <li key={person.name}>
                <div className="flex items-center gap-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold leading-6 text-indigo-600 cursor-pointer">{person.role}</p>
                  </div>
                </div>
              </li>
            ))}
